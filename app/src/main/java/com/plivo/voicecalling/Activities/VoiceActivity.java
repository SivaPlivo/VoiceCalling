...
public class VoiceActivity extends AppCompatActivity implements EndPointListner {
    ...
    EditText dtmfText;
    Button answerBtn, declineBtn, muteBtn, holdBtn, dtmfBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dtmfText = (EditText) findViewById(R.id.editText1);
    ...
    public void onIncomingDigitNotification(String digits) {
        ...
        Toast.makeText(this, "Incoming DTMF: "+digits, Toast.LENGTH_SHORT).show();
